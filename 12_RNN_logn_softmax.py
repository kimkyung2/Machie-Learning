# -*- coding: utf-8 -*-
"""
Created on Mon May  9 16:27:46 2022
...
def RNN_long():
    ...
    x = tf.contrib.placeholder(shape = [None, seq_length], dtype = tf.int32)
    y = tf.contrib.placeholder(shape = [None, seq_length], dtype = tf.int32)
    ...
    cell = tf.BasicLSTMCell(hidden_size, state_is_tuple = True)
    cell = tf.MultiRNNCell([cell]*2, state_is_tuple=True)
